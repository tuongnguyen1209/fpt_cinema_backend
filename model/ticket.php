...
class ticket
{
    ...
    {
        $query = "SELECT user.full_name,movie.image_medium, tk.id_ticket,movie.name_mv,se.day,sts.time_start,room.id_room,tk.ticket_information,tk.status,tk.Total_money FROM ticket tk INNER JOIN user on tk.id_user =user.id_user INNER JOIN promotion pr ON tk.id_promotion = pr.id_promotion INNER JOIN
        session se ON tk.id_session = se.id_session INNER JOIN showtimes sts ON se.id_showtimes = sts.id_showtimes INNER JOIN room on se.id_room =room.id_room  INNER JOIN movie ON se.id_movie =movie.id_movie GROUP BY tk.id_ticket ORDER BY tk.id_ticket        ";
    ...
    {
        if ($type == "TK_code") {
            $query = "SELECT user.full_name, tk.id_ticket,movie.name_mv,user.email,movie.image_medium,user.phone,se.day,sts.time_start,tk.time_create,room.id_room,tk.ticket_information,tk.status,tk.Total_money FROM ticket tk INNER JOIN user on tk.id_user =user.id_user INNER JOIN promotion pr ON tk.id_promotion = pr.id_promotion INNER JOIN
            ...
            $query = "SELECT user.full_name, tk.id_ticket,movie.name_mv,user.email,movie.image_medium,user.phone,se.day,sts.time_start,tk.time_create,room.id_room,tk.ticket_information,tk.status,tk.Total_money FROM ticket tk INNER JOIN user on tk.id_user =user.id_user INNER JOIN promotion pr ON tk.id_promotion = pr.id_promotion INNER JOIN
            session se ON tk.id_session = se.id_session INNER JOIN showtimes sts ON se.id_showtimes = sts.id_showtimes INNER JOIN room on se.id_room =room.id_room  INNER JOIN movie ON se.id_movie =movie.id_movie where user.id_user =? GROUP BY user.id_user ORDER BY user.id_user";
        } else {
            $query = "SELECT user.full_name, tk.id_ticket,movie.name_mv,user.email,movie.image_medium,user.phone,se.day,sts.time_start,tk.time_create,room.id_room,tk.ticket_information,tk.status,tk.Total_money FROM ticket tk INNER JOIN user on tk.id_user =user.id_user INNER JOIN promotion pr ON tk.id_promotion = pr.id_promotion INNER JOIN
